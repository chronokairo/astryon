    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.info), label: ("Quem Somos")),
          BottomNavigationBarItem(icon: Icon(Icons.person), label: ("Contato")),
          BottomNavigationBarItem(
              icon: Icon(Icons.groups), label: ("Assembleias")),
          BottomNavigationBarItem(
              icon: Icon(Icons.handshake), label: ("Seja nosso parceiro")),
