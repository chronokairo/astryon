...
class ConsorcioCasaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Consórcio de Casa'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('- Possibilidade de adquirir uma casa sem pagar juros'),
            ...
            const Text('4. Utilize a carta de crédito para comprar a casa desejada'),
            const SizedBox(height: 16),
            const Text(
